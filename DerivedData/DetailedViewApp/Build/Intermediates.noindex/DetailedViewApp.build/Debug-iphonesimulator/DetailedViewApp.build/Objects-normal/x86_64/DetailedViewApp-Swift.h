...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DetailedViewApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15DetailedViewApp11AppDelegate")
...
SWIFT_CLASS("_TtC15DetailedViewApp13SceneDelegate")
...
SWIFT_CLASS("_TtC15DetailedViewApp8SecondVC")
@interface SecondVC : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified learnLabel;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC15DetailedViewApp14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)with;
